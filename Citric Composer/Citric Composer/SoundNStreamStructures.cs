    ...
    public static class EncoderFactory
    {
        ...
        public static byte[][] Pcm16ToDspApdcmWAV(Int16[][] pcm16, ref b_wav b)
        {
            ...
            for (int i = 0; i < data.Length; i++) {
                ...
                data[i] = DspAdpcmEncoder.EncodeSamples(pcm16[i], out b.info.channelInfo[i].dspAdpcmInfo);
            }
            return data;
        ...
        /// <returns>object[byte[] dspAdpcm, SoundNStreamSeekBlock seekBlock].</returns>
        public static byte[][] Pcm16ToDspAdpcmAndSeek(Int16[][] pcm16, b_stm s)
        {
            ...
            for (int i = 0; i < data.Length; i++)
            {
                ...
                data[i] = DspAdpcmEncoder.EncodeSamples(pcm16[i], out s.info.channels[i].dspAdpcmInfo);
            }
            return data;
